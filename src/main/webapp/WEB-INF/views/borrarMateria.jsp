<%-- 
    ...
    Created on : Apr 15, 2017, 10:12:57 PM
    Author     : silvina
--%>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="col-md-4">
                       ...
                       <a class="btn btn-danger custom-width" onclick="return confirm('Seguro que desea eliminar?')" href="<spring:url value='/Materias/borrar/${codMateria}'/>">Eliminar</a>
